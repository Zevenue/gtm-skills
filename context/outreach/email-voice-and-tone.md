...
### How Zevenue-written outbound should sound
- **Direct.** No warm-up sentences. No "I hope this finds you well." Start with their situation.
...
### Use
- "Most [role]s I've talked to..." (social proof without name-dropping)
- "The teams that [solved X] usually..." (pattern recognition)
- "Is that your experience?" / "Am I close?" / "Off base?" (inquisition CTAs)
- "Noticed" / "Saw" / "Found" (observational framing)
- Specific numbers and percentages when available from data
...
- 2-5 words only
- Lowercase (never title case, never ALL CAPS)
- Reference something specific: their tool, their role, a metric, their situation
- Create curiosity without being clickbait
- No punctuation tricks (no "!!!", single "?" is fine)

**Pattern:** [their thing] + [specificity cue]
- `coordinator role` (references their job post)
- `mindbody + eventbrite` (references their tech stack)
- `post-raise hiring` (references their situation)
- `pick error rates` (references a specific metric)
- `lead time variability` (references a topic they care about)
...
- First line must be about THEM, never about you

### Email 2 (follow-up 1)
- 4 lines maximum
- Under 60 words
- Can include 1 link if necessary
- Rotate the angle from Email 1
- Can thread or start new subject
...
- Case study, resource offer, or clean breakup
- Never guilt-trip ("I've sent you 3 emails...")
...
- Greeting: First name only, or no greeting. Never "Dear" or "Hello."
- Sign-off: First name only. No title, no company, no phone number in Email 1. Minimal signature in follow-ups.
